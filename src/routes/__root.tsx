...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ilona Endocrine & Wellness Centre | Hormonal Precision Care" },
      { name: "description", content: "Premium endocrine, thyroid, diabetes & hormonal care led by Dr. Kunal Gupta. Precision diagnostics for metabolic wellness." },
      { name: "author", content: "Ilona Endocrine & Wellness Centre" },
